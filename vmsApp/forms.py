...
class SaveVisitor(forms.ModelForm):
    ...
    court_id = forms.CharField(max_length=250)
    case_id = forms.CharField(max_length=250)
    person_id = forms.CharField(max_length=250)
    name = forms.CharField(max_length=250)
    ...
    class Meta:
        ...
        fields = ('name','court_id','case_id','person_id','department', 'gender', 'contact', 'email', 'address', 'reason', 'comment',)
